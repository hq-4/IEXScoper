...
from utils.legacy.sec_high_impact_outputs import existing_override_ids, write_run_outputs
from utils.legacy.sec_high_impact_state import WORKFLOW_VERSION, read_json, write_csv
...
def regenerate_reporting() -> None:
    commands = (
        ...
        (
            "utils/legacy/build_dead_ticker_resolution_lanes.py",
            "--output-root",
            "reports/dead-ticker-review/resolution-lanes",
        ),
        ("utils/legacy/build_dead_ticker_resolution_workplan.py",),
    )
